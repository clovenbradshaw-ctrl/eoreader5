...
const FAST_OPTS = { shuffles: 15, maxRounds: 2, maxOperators: 2, enumeration: { lags: [1, 6], maxSeriesDepth: 2, maxPrograms: 512 } };
...
test("dependency_graph is computed from real opref references, not a placeholder", () => {
  ...
  const deep = { shuffles: 30, enumeration: { lags: [1, 6], maxSeriesDepth: 2, maxPrograms: 512 }, maxRounds: 3, maxOperators: 4 };
